...
Modified by eelis.mielonen@epfl.ch 
"""
import random
import time
import warnings
...
def main(args: argparse.Namespace):
    ...
    #split source training set to get a validation set for source domain
    ...
    for epoch in range(args.epochs):
        ...
        acc1, acc_global, acc, iu = utils.validate(val_loader, classifier, args, device)
    ...
    acc1, acc_global, acc, iu = utils.validate(test_loader, classifier, args, device)
    acc1_s, acc_global_s, acc_s, iu_s = utils.validate(test_source_loader, classifier, args, device)
    print("test_acc1 = {:3.1f}".format(acc1))
    print("test_source_acc1 = {:3.1f}".format(acc1_s)) 
    print("target class accuracies = ", acc)
    print("target source accuracies = ", acc_s)
